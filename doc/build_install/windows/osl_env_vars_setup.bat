...
set BASE_LOCATION=C:/madoodia/sdks
set PYTHON_LOCATION="C:/Program Files/Python37"
set QT_LOCATION=C:/Qt/5.15.0/msvc2019_64
set QT6_LOCATION=C:/Qt_6/6.5.3/msvc2019_64
set NASM_LOCATION="C:/Program Files/NASM"
...
echo QT6_LOCATION      :   %QT6_LOCATION%
